...
export default {
    ...
    methods:{
        getLoan: function(){
            ...
            this.$http.get("https://l2edobifo9.execute-api.us-east-2.amazonaws.com/dev/loan/"+this.id)
            .then(response =>{
        ...
        editLoanForm: function(){
            console.log(this.id)
            this.$http.put("https://l2edobifo9.execute-api.us-east-2.amazonaws.com/dev/loan/"+this.id,this.editLoan)
            .then(response =>{
                console.log(response)
                this.$router.push({
